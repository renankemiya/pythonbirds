...
class Passaro(Ator):
    ...
    def calcular_posicao(self, tempo):
        ...
        if self._esta_voando():
            ...
            self._calcular_posica_vertical(delta_t)
            self._calcular_posica_horizontal(delta_t)
    ...
    def _calcular_posica_vertical(self, delta_t):
    ...
    def _calcular_posica_horizontal(self, delta_t):
